...
def compute_piece_pitch_entropy(
    piece_ev_seq, window_size, bar_ev_id=BAR_EV, pitch_evs=PITCH_EVS, verbose=False
):
    """
...
def compute_piece_groove_similarity(
    piece_ev_seq, bar_ev_id=BAR_EV, pos_evs=POS_EVS, pitch_evs=PITCH_EVS, max_pairs=1000
):
    """
